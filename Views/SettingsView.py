...
class SettingsView (object):
	def __init__(self, docset_management_view, cheatsheet_management_view, usercontributed_management_view):
		...
		self.usercontributed_management_view = usercontributed_management_view
	...
	def tableview_did_select(self, tableview, section, row):
		if self.docset_section_number == section:
			if self.manage_docset_row == row:
				...
				tv.navigation_view.push_view(self.usercontributed_management_view)
...
def get_view(docset_management_view, cheatsheet_management_view, usercontributed_management_view):
	w,h = ui.get_screen_size()
	tv.width = w
	tv.height = h
	tv.flex = 'WH'
	tv.name = 'Settings'
	data = SettingsView(docset_management_view, cheatsheet_management_view, usercontributed_management_view)
	tv.delegate = data
	tv.data_source = data
	return tv
